  ...
  const {EMAIL, EMAIL_CLIENT_ID, EMAIL_CLIENT_SECRET, EMAIL_CLIENT_REDIRECT_URI, EMAIL_REFRESH_TOKEN} = require('../config/serverConfig');
    ...
    console.log("EMAIL",EMAIL, "EMAIL_CLIENT_ID",EMAIL_CLIENT_ID, "EMAIL_CLIENT_SECRET",EMAIL_CLIENT_SECRET, "EMAIL_CLIENT_REDIRECT_URI",EMAIL_CLIENT_REDIRECT_URI, "EMAIL_REFRESH_TOKEN",EMAIL_REFRESH_TOKEN)
